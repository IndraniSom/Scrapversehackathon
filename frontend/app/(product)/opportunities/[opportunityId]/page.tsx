...
export default async function OpportunityPage({ params, searchParams: _searchParams }: { params: Promise<{ opportunityId: string }>; searchParams?: Promise<Record<string, string>> }) {
  void _searchParams;
